-- 425185
import Euler(readMatrix, walkMatrixDown, walkMatrixLeft,
             walkMatrixRight, walkMatrixUp)
...
bestPath0 m s
    ...
    where s2 = walkMatrixLeft m $ walkMatrixUp m $
               walkMatrixDown m $ walkMatrixRight m s
